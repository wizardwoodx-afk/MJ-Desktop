...
var show = (id) => {
  ...
  console.log(id, "| cat:", d.category, "| in:", JSON.stringify((d.inputs ?? []).map((p2) => [p2.id, p2.dataType, p2.required])), "| out:", JSON.stringify((d.outputs ?? []).map((p2) => [p2.id, p2.dataType])));
};
