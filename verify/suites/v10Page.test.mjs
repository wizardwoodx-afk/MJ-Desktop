...
// src/version.ts
var VH_VERSION = "16.4.1";
var VH_SHORT = VH_VERSION.split(".").slice(0, 2).join(".");
var VH_TITLE = `Vouch Harbor ${VH_SHORT}`;
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { overflowX: "auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { className: "tbl", style: { width: "100%", fontSize: 11 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: rows.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { style: { textAlign: "left" }, children: c.maxTurns?.argv?.join(" ") ?? "none \u2014 MJ's ledger only" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { style: { textAlign: "left" }, children: c.timeout?.argv?.join(" ") ?? "none \u2014 MJ's deadline" }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { style: { textAlign: "left" }, children: c.sessionStart ? "MJ chooses" : "CLI chooses" }),
...
ok("it names the release from the single source of truth", text.includes(`MJ ${VH_SHORT}`), `no MJ ${VH_SHORT}`);
