...
var EXPECTED_DOORS = ["teammate", "loop", "workflow", "proof", "audit", "settings"];
...
ok(
  "engine holds teammate+loop+workflow, verify holds proof+audit, system holds settings",
  groupsSection.includes('n.key === "teammate" || n.key === "loop" || n.key === "workflow"') && groupsSection.includes('n.key === "proof" || n.key === "audit"') && groupsSection.includes('n.key === "settings"')
);
