...
pub fn run() {
    tauri::Builder::default()
        ...
        // 13.5.1-windows-fix: the updater plugin init was removed. It was
        ...
        // endpoints, no pubkey, no artifacts and zero callers (capability
        // grant already removed in 11.14.5), so the init line goes; updates
        // remain "download the new zip and reinstall". Re-add ONLY together
        // with a real `plugins.updater` config section.
        .setup(|app| {
