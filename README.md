# MJ 13.0.1 — the One-Engine desktop runtime for agent work
...
| Daylight theme | |
|---|---|
| ![Daylight](media/screenshots/08-daylight-canvas.png) | Six INK palettes ship on true-black grounds — smoked apricot, dusty rose, whetstone, seedpod olive — with ivory and travertine as the paper-light pair. Ctrl+B collapses the sidebar. |
...
node verify/run.mjs   # 74 bundles
```
...
probe/       75 probe suites, run by `npm test`
