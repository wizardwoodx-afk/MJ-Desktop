...
| Platform | Output |
|---|---|
| Windows | `src-tauri/target/release/bundle/nsis/Vouch Harbor_16.0.0_x64-setup.exe` |
...
| `tauri build` → NSIS installer | ok — `Vouch Harbor_16.0.0_x64-setup.exe`, installs per-user |
