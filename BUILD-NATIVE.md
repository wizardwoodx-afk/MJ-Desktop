...
| Platform | Output |
|---|---|
| Windows | `src-tauri/target/release/bundle/nsis/MJ_11.14.11_x64-setup.exe` |
| macOS | `src-tauri/target/release/bundle/macos/MJ.app` + `.dmg` |
| Linux | `src-tauri/target/release/bundle/appimage/MJ_11.14.11_amd64.AppImage` + `.deb` |
