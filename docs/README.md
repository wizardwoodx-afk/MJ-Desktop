...
- `history/VH-16.4.1-POINTER.md` — discoverable pointer for this release
- `history/VH-16.4.1-WINDOWS-FIX.md` — what the Windows fix changed
  relative to the shipped 16.4.1 zip (every difference listed)
