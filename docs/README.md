...
- `history/VH-16.5.0-POINTER.md` — discoverable pointer for this release
- `history/VH-16.5.0-WINDOWS-FIX.md` — what the Windows fix changed
  relative to the shipped 16.5.0 zip (every difference listed)
