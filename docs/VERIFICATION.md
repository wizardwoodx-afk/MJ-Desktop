...
This executes the 72 runtime probe suites as self-contained bundles — no `npm ci`,
...
npm test              # 73 suites (72 runtime + the offline-pack freshness gate)
...
| Claim | Tier 1 | Tier 2 |
|---|---|---|
| The 72 runtime probe suites pass (incl. the 270-assertion harness suite) | ✔ | ✔ |
