...
- **drill, mcpRouter, metaLoop** (16.2–16.4) — the drill line: real-mission
  drills on real git repos with honest-failure scenarios, the MCP capability
  router (20 governed tools, byte-pinned engine bundle), the gated reversible
  meta-loop. Measured on this tree: 88/88 live, 87/87 offline.
