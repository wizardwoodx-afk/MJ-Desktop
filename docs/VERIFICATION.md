...
This executes the 69 runtime probe suites as self-contained bundles — no `npm ci`,
...
npm test              # 70 suites (69 runtime + the offline-pack freshness gate)
...
| Claim | Tier 1 | Tier 2 |
|---|---|---|
| The 69 runtime probe suites pass (incl. the 270-assertion harness suite) | ✔ | ✔ |
