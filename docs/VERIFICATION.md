...
This executes the 71 runtime probe suites as self-contained bundles — no `npm ci`,
...
npm test              # 72 suites (71 runtime + the offline-pack freshness gate)
...
| Claim | Tier 1 | Tier 2 |
|---|---|---|
| The 71 runtime probe suites pass (incl. the 270-assertion harness suite) | ✔ | ✔ |
