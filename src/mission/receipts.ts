...
export interface ProofReceipt {
  /**
   * mj-proof-receipt/2 (11.10.1): v1 chain + seal, plus `issuer`/`signature` — an Ed25519
   ...
   */
  format: "mj-proof-receipt/2" | "mj-proof-receipt/1";
  header: {
    mission: string;
    teamId: string;
    startedAt: string;
 ...
 * Accepts BOTH mj-proof-receipt/1 and /2 — v1 receipts (pre-11.10.1) verify exactly as
