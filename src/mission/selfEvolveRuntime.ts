...
/** 11.12 — canonical digest of the current world-belief, for action packets. */
...
/**
 * Pure briefing composer: org lessons + causal memory + beliefs + approved
 * learned skills, budgeted by the GOVERNING strategy. Mosaic lines only enter
 * when the governing strategy's regime dimension says so — which is exactly
 * what makes the extract measurable as an experiment arm.
 */
