...
export interface StrategyParams {
  ...
  /**
   * 11.12 MOSAIC alignment — the regime dimension: when true, runs carry the
   * MOSAIC extract (belief lines in briefings, signed action packet, causal
   * retrieval). The experiment therefore measures, on attributed runs, whether
   * the framework extract improves MJ — adoption or retirement with numbers.
   */
  mosaic: boolean;
}
