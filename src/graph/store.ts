...
export type ThemeId = "ink" | "pitch" | "slag" | "fern" | "ivory" | "travertine";

/** One list of themes, owned here. SettingsPage renders it; the theme probe cross-checks CSS. */
export const THEME_IDS: ThemeId[] = ["ink", "pitch", "slag", "fern", "ivory", "travertine"];
...
/**
 * 13.0.1 — the INK set (black + unknown minerals) replaced the OBSIDIAN six,
 * which replaced the INSCRIBED fourteen. Old saved preferences migrate
 * deliberately to the closest new palette — never silently coerced:
 *   obsidian/wabi/nth/indigo/hazard/void…      → ink      (flagship dark)
 *   onyx/orchid/aurora/nothing/inscribed…      → pitch    (OLED dark)
 *   hematite/carbon/cyanotype/terminal…        → slag     (cool graphite)
 *   peat/bone/sage/paper/hermes…               → fern     (earthy dark)
 *   ivory/chalk/daylight/solar/porcelain…      → ivory/travertine (lights)
 */
const THEME_ALIASES: Record<string, ThemeId> = {
  obsidian: "ink", wabi: "ink", nth: "ink", indigo: "ink", hazard: "ink",
  void: "ink", monochrome: "ink", "cyber-matrix": "ink", nord: "ink", graphite: "ink",
  onyx: "pitch", orchid: "pitch", aurora: "pitch", "tokyo-night": "pitch",
  nothing: "pitch", inscribed: "pitch",
  hematite: "slag", carbon: "slag", cyanotype: "slag", terminal: "slag",
  peat: "fern", bone: "fern", sage: "fern", paper: "fern", hermes: "fern",
  ivory: "ivory", chalk: "ivory", solar: "ivory", daylight: "ivory",
  travertine: "travertine", porcelain: "travertine", "nothing-light": "travertine",
};
...
export function getEditorPrefs(): EditorPrefs {
  ...
  return { snap: 16, autosaveMs: 1200, theme: "ink", showMinimap: true, showGrid: true, reducedMotion: false };
}
