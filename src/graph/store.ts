...
export type ThemeId = "nth" | "inscribed" | "chalk" | "carbon" | "bone" | "indigo" | "sage" | "hazard" | "orchid" | "porcelain" | "aurora" | "wabi" | "cyanotype" | "daylight";

/** One list of themes, owned here. SettingsPage renders it; the theme probe cross-checks CSS. */
export const THEME_IDS: ThemeId[] = ["nth", "inscribed", "chalk", "carbon", "bone", "indigo", "sage", "hazard", "orchid", "porcelain", "aurora", "wabi", "cyanotype", "daylight"];
