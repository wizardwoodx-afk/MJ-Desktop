  ...
  return (
    <div className="panel-page">
      ...
      <div className="card" style={{ marginTop: 16 }}>
        ...
        <div className="muted">One Inscribed design system, fourteen palettes — monochrome canvas, one accent signal, dot-matrix display type. wabi · charcoal ground, washi ink, kiln signal — five-color minimal (default) — cyanotype · Prussian ground, paper ink, exposure-cyan signal — five-color rare (11.9.5) — nth · carbon ground, cream ink, brass accent + verdigris pulse — inscribed · Nothing OS dark, signal red — chalk · the system on paper — carbon · industrial, phosphor green — bone · parchment, terracotta — indigo · slate dark, ice blue — sage · botanical light, forest green — hazard · soot dark, safety yellow — orchid · noir plum, orchid magenta — porcelain · porcelain light, ultraviolet — aurora · deep blue-teal night, ice signal — daylight · warm paper ground, ink text, kiln-copper signal — the 11.10.7 clarity light look</div>
        <div className="row" style={{ marginTop: 10, flexWrap: "wrap", gap: 6 }}>
          {(["wabi", "nth", "cyanotype", "inscribed", "chalk", "carbon", "bone", "indigo", "sage", "hazard", "orchid", "porcelain", "aurora", "daylight"] as const).map((t) => (
