  ...
  return (
    <div className="panel-page">
      ...
      <div className="card">
        ...
        <div className="muted">One Inscribed design system, twelve palettes — monochrome canvas, one accent signal, dot-matrix display type. wabi · charcoal ground, washi ink, kiln signal — five-color minimal (default) — nth · carbon ground, cream ink, brass accent + verdigris pulse — inscribed · Nothing OS dark, signal red — chalk · the system on paper — carbon · industrial, phosphor green — bone · parchment, terracotta — indigo · slate dark, ice blue — sage · botanical light, forest green — hazard · soot dark, safety yellow — orchid · noir plum, orchid magenta — porcelain · porcelain light, ultraviolet — aurora · deep blue-teal night, ice signal</div>
        <div className="row" style={{ marginTop: 10, flexWrap: "wrap", gap: 6 }}>
          {(["wabi", "nth", "inscribed", "chalk", "carbon", "bone", "indigo", "sage", "hazard", "orchid", "porcelain", "aurora"] as const).map((t) => (
