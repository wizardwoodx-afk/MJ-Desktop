    ...
    <div className="panel-page">
      ...
      <div className="row" style={{ margin: "12px 0" }}>
        ...
        <button
          ...
          onClick={() => {
            const bom = buildAibom({ records: globalReceiptVault.list(), ownedHarnesses: loadRoleBoard().owned, mjVersion: MJ_VERSION });
            downloadText(`mj-aibom-${new Date().toISOString().slice(0, 10)}.json`, JSON.stringify(bom, null, 2) + "\n", "application/json");
            downloadText(`mj-aibom-${new Date().toISOString().slice(0, 10)}.md`, aibomToMarkdown(bom), "text/markdown");
            ...
            <div style={{ marginTop: 8, padding: 8, borderRadius: 4, background: "var(--bg-elevated)", border: "1px solid var(--border)", fontSize: 12 }}>
              <div className="row" style={{ justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div className="row" style={{ gap: 6 }}>
                  ...
                  <button onClick={() => downloadText(`mj-provenance-${r.id}.json`, JSON.stringify(r.provenance, null, 2), "application/json")}>
                    Provenance
                  </button>
                  <button
                    onClick={async () => {
