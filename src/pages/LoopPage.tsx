      ...
      <div className="card" style={{ marginTop: 12 }}>
        ...
        {native && llmSel !== "off" && (
          <div className="muted" style={{ fontSize: 11, marginTop: 6, border: "1px solid var(--border, #333)", borderRadius: 6, padding: "4px 8px" }}>
            Disclosure: the {llmSel} pass sends the document to that harness's configured model provider. MJ cannot see the harness's own endpoint overrides — declare the endpoint above if you know it (local model vs default cloud); otherwise the proposal records "unknown, not visible to MJ". Mechanical distillation is fully local — no content leaves the machine.
          </div>
        )}
