...
import { buildProofReceipt, receiptFromJsonl, receiptToJsonl, verifyProofReceipt } from "../mission/receipts";
            ...
            <div style={{ marginTop: 20, paddingTop: 16, borderTop: "1px solid var(--border)" }}>
              ...
              <div className="row" style={{ marginTop: 10 }}>
                <button onClick={async () => {
                  ...
                  setReceiptMsg("Proof receipt exported — SHA-256 chain + seal attached. Any auditor can re-run verifyProofReceipt.");
