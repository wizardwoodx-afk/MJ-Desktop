...
import { settleSelfEvolution } from "../mission/selfEvolveRuntime";
  ...
  const handleRunMission = async () => {
    ...
    try {
      ...
      try {
        ...
        if (evSummary.lessonsLearned > 0 || evSummary.learningReceiptId) {
          toast(`Self-evolution: ${evSummary.lessonsLearned} lesson(s) → memory (${evSummary.memorySize}), strategy v${evSummary.strategy.adoptedGen}${evSummary.learningReceiptId ? ", receipt signed" : ""}`);
        }
      } catch (evErr) {
