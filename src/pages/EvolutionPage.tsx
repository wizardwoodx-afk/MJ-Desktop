  ...
  return (
    <div className="panel-page">
      ...
      <div className="card">
        ...
        <p className="muted">
          Everything that needs a human, in one place: skill proposals, beliefs MJ inferred about
      ...
      <div className="card">
        <div className="card-title">Pattern registry — MJ studies other agents, keeps the patterns, never the code <span className="pill">11.13.1</span></div>
        <p className="muted">
          Where MJ observed each capability pattern, under what license the observed project lives
          (reference only — no code is copied), and how MJ adopts it independently. Proposing a
