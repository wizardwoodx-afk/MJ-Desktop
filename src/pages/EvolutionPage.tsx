...
import { loadImprovement, adoptedVersion } from "../mission/selfImprove";
...
export function EvolutionPage() {
  ...
  return (
    <div className="panel-page">
      ...
      <div className="card">
        <div className="card-title">Self-evolution — lessons · strategy loop · skills <span className="pill">11.11</span></div>
        <p className="muted">
          Real runs reflect into lessons, the strategy archive adopts only measured
          improvement, and whatever the org learns is signed as a learning receipt.
          Simulated runs teach nothing about real execution.
        </p>
