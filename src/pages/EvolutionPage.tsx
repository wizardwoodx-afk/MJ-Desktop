...
function experimentSummary(): string {
  ...
  return [
    ...
    candidate ? `candidate params: reviewDepth ${candidate.params.reviewDepth} · checkBias ${candidate.params.checkBias} · serialExec ${candidate.params.serialExec} · lessonBudget ${candidate.params.lessonBudget} · mosaic ${candidate.params.mosaic ? "ON" : "off"}` : "no candidate in the field — next verified settlement proposes one",
