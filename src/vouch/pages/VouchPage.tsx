  ...
  return (
    <div className="tm-root">
      <style>{`
        ...
        .tm-skill-on{border-color:var(--accent,#ff4d00)!important}
        .tm-timeline{margin-top:6px;padding:6px 8px;border:1px dashed var(--border,#2a2a2c);border-radius:6px;display:flex;flex-direction:column;gap:3px}
        .tm-tl-step{display:flex;gap:6px;align-items:baseline;font-size:10px}
        .tm-tag-mission{color:#7fb0d9;border-color:#3a5a74}
        ...
        .tm-step-council{border-left:2px solid #5b8cff}
        .tm-council-seat{display:block;margin:2px 0;opacity:.92}
        .tm-council-seat em{opacity:.6;font-size:.92em}
        .tm-council-synthesis{margin-top:4px;padding:6px 8px;background:rgba(91,140,255,.08);border-radius:6px;font-size:.95em}
        .tm-council-synthesis div{margin:1px 0}
    `}</style>
      ...
      <section className="tm-chat">
        ...
        <div className="tm-composer">
          <div className="tm-chips" style={{ margin: 0, flexWrap: "nowrap" }}>
            <button className="tm-chip" style={sess.mode === "quick" ? { borderColor: "var(--accent,#ff4d00)" } : undefined} onClick={() => setVouchMode("quick" as VouchMode)}>Quick</button>
            <button className="tm-chip" style={sess.mode === "deep" ? { borderColor: "var(--accent,#ff4d00)" } : undefined} onClick={() => setVouchMode("deep" as VouchMode)}>Deep ⚡</button>
          </div>
          <textarea
            className="tm-input"
            rows={1}
      ...
      <aside className="tm-rail" aria-label="Vouch context">
