/**
 * MJ 15.0.0 — the navigation SINGLE SOURCE OF TRUTH (One Engine, six doors).
 *
 ...
 * makes it canonical: the VOUCH door is the ROGUE control plane — a named,
...
export const NAV: NavEntry[] = [
  { key: "teammate", label: "Vouch", icon: "users", description: "The face — ROGUE, the accountable colleague: recall, plan, council, signed simulation, a human gate for risky actions, and a signed receipt for every run. Dispatches real missions to the engine." },
