 ...
 * §3 buildProofReceipt issues mj-proof-receipt/2 with a signature verifyProofReceipt accepts
...
describe("issuer signing — receipts become v2 and issuer-authentic", () => {
  ...
  it("v1 receipts (pre-11.10.1) still verify — backward compatibility", async () => {
    ...
    // Simulate an older archived receipt: same chain and seal, no issuer fields, v1 format.
    const v1 = { ...rc, format: "mj-proof-receipt/1" as const, issuer: undefined, signature: undefined, signatureNote: undefined };
