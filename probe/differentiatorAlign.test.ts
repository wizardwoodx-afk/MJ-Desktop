 ...
 *
 * Pins the three features that make MJ a different product in the 2026 agent
 * market (per the research: coding agents compete on benchmarks and inline UX;
 * NONE ship spend authority, digest-stamped proof-of-work export, or measured
 * proof-of-learning):
...
import { buildProofDossier, verifyProofDossier } from "../src/mission/dossier";
