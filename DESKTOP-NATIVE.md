# MJ 11.14.11 — Desktop native install
...
`rustc 1.98.0` and exercised. What has *not* been compiled is the two
`#[tauri::command]` functions that use the Tauri macro (`cli_invoke`, `cli_env`)
and the registration line in `src-tauri/src/lib.rs`.
