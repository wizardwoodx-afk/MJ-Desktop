# Install Vouch Harbor 16.0.0 on your laptop (Windows 11) — the only supported install
...
```
src-tauri\target\release\bundle\nsis\Vouch Harbor_16.0.0_x64-setup.exe
```
...
1. The header says **Vouch Harbor 16.0** (Help → About must agree — `probe/versionDrift` enforces this).
